...
"""
class MeuThread(Thread):  # criando uma classe thread personalizada
...
t1 = Thread(target=vai_demorar, args=('Olá mundo 1!', 5))   # criando thread com a classe Thread
t1.start()
...
while t1.is_alive(): # comportamento bloqueante
...
t1 = Thread(target=vai_demorar, args=('Olá mundo 1!', 10))
t1.start()
t1.join()  # serve para bloquear a thread. Aguarda a thread acabar, assim como o codigo acima.
print('Thread acabou!')
"""
