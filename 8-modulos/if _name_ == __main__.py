...
# isso pergunta se o codigo desse arquivo esta sendo executado dentro do arquivo principal ou como um modulo importado
...
print(main())
print(
    __name__)  # mostra (__main__) se a execução foi inicializada pelo proprio arquivo, ou __nomedomodulo__ se executado
